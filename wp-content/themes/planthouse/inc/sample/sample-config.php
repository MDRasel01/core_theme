...
$args = array(
	...
	'menu_title'                => esc_html__( 'PLanthouse Options', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Logo', 'planthouse' ),
		'id'               => 'logo',
		'desc'             => esc_html__( 'change your logo from here', 'planthouse' ),
		...
		'fields'           => array(
			...
			array(
					...
					'id'           => 'header_tittle',
					'tittle'       => esc_html__( 'Header tittle', 'planthouse' ),
					'desc'         => esc_html__( 'change your logo from here', 'planthouse' ),
					'type'         => 'text',
			),
		),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'header logo', 'planthouse' ),
		'id'               => 'header_logo',
		'desc'             => esc_html__( 'change your logo from here', 'planthouse' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-dribbble',
		'fields'           => array(
			...
			array(
					...
					'id'           => 'header_logo',
					'tittle'       => esc_html__( 'Header logo', 'planthouse' ),
					'desc'         => esc_html__( 'change your logo from here', 'planthouse' ),
					'type'         => 'media',
			),
		),
...
// 	$opt_name,
// 	array(
// 		'title'            => esc_html__( 'footer', 'planthouse' ),
// 		'id'               => 'footer',
// 		'desc'             => esc_html__( 'change your footer info from here', 'planthouse' ),
// 		'customizer_width' => '400px',
// 		'icon'             => 'el el-dribbble',
// 		'fields'           => array(
...
// 					'id'           => 'copyright',
// 					'desc'         => esc_html__( 'change your copyright info from here', 'planthouse' ),
// 			),
// 		),
// 	)
// );
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'social_links', 'planthouse' ),
		'id'               => 's_links',
		'desc'             => esc_html__( 'add your social media links', 'planthouse' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-dribbble',
		'fields'           => array(
			...
			array(
					...
					'id'           => 'facebook',
					'tittle'       => esc_html__( ' facebook link', 'planthouse' ),
					'type'         => 'text',
			),
			array(

					'id'           => 'twitter',
					'tittle'       => esc_html__( ' twitter link', 'planthouse' ),
					'type'         => 'text',
			),
			array(

				'id'           => 'github',
				'tittle'       => esc_html__( 'Github link', 'planthouse' ),
				'type'         => 'text',
		   ),
		   array(

			'id'           => 'behance',
			'tittle'       => esc_html__( 'Behance link', 'planthouse' ),
			'type'         => 'text',
	       ),
		),
	)
